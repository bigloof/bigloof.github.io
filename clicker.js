...
setInterval(function renderCoins() {document.getElementById("coins").innerHTML = "$" + AbbreviateNumber(coins); });
setInterval(function renderCoins() {document.getElementById("coinsPS").innerHTML = "$" + AbbreviateNumber(coinsPS) + " /sec"; });
setInterval(function renderCoins() {document.getElementById("UpCost50").innerHTML = "+ $" + AbbreviateNumber(UpCost50); });
setInterval(function renderCoins() {document.getElementById("UpCost100").innerHTML = "+ $" + AbbreviateNumber(UpCost100); });
setInterval(function renderCoins() {document.getElementById("UpCost1000").innerHTML = "+ $" + AbbreviateNumber(UpCost1000); });
setInterval(function renderCoins() {document.getElementById("UpCostMil").innerHTML = "+ $" + AbbreviateNumber(UpCostMil); });
setInterval(function renderCoins() {document.getElementById("UpCostBil").innerHTML = "+ $" + AbbreviateNumber(UpCostBil); });
setInterval(function renderCoins() {document.getElementById("UpCostTril").innerHTML = "+ $" + AbbreviateNumber(UpCostTril); });
